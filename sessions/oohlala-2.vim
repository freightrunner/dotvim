...
set shortmess=aoO
badd +1 app/models/picture.rb
badd +8 app/models/location.rb
badd +13 app/models/city.rb
badd +3 app/models/post.rb
badd +3 app/assets/stylesheets/base.scss
badd +11 config/initializers/assets.rb
badd +0 app/views/categories/_form.html.slim
argglobal
silent! argdel *
$argadd app/views/categories/_form.html.slim
edit app/assets/stylesheets/base.scss
...
setlocal path=.,~/Oohlala/lib,~/Oohlala/vendor,~/Oohlala/app/models/concerns,~/Oohlala/app/controllers/concerns,~/Oohlala/app/controllers,~/Oohlala/app/helpers,~/Oohlala/app/mailers,~/Oohlala/app/models,~/Oohlala/app/*,~/Oohlala/app/views,~/Oohlala/test,~/Oohlala/test/unit,~/Oohlala/test/functional,~/Oohlala/test/integration,~/Oohlala/test/controllers,~/Oohlala/test/helpers,~/Oohlala/test/mailers,~/Oohlala/test/models,~/Oohlala/spec,~/Oohlala/spec/controllers,~/Oohlala/spec/helpers,~/Oohlala/spec/mailers,~/Oohlala/spec/models,~/Oohlala/spec/views,~/Oohlala/spec/lib,~/Oohlala/spec/features,~/Oohlala/spec/requests,~/Oohlala/spec/integration,~/Oohlala/vendor/plugins/*/lib,~/Oohlala/vendor/plugins/*/test,~/Oohlala/vendor/rails/*/lib,~/Oohlala/vendor/rails/*/test,~/Oohlala,/usr/include
