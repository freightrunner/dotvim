...
set shortmess=aoO
badd +1 lib/tasks/create_brand_with_images.rake
badd +36 app/controllers/v2/orders_controller.rb
badd +1 app/controllers/v2/payments_controller.rb
badd +45 lib/tasks/create_cart_and_items.rake
badd +20 app/services/carts/generator.rb
badd +1 app/services/carts/processor.rb
badd +37 config/mongoid.yml
argglobal
silent! argdel *
$argadd lib/tasks/create_brand_with_images.rake
edit lib/tasks/create_cart_and_items.rake
