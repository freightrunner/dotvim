...
set shortmess=aoO
badd +1 app/views/v2/labels/shared/domestic/_print_all.html.erb
badd +0 config/initializers/01_initialize_feature_flags.rb
argglobal
silent! argdel *
$argadd app/views/v2/labels/shared/domestic/_print_all.html.erb
...
let s:l = 52 - ((47 * winheight(0) + 24) / 49)
