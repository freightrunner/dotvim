...
set shortmess=aoO
badd +13 app/controllers/partners_controller.rb
badd +35 config/routes.rb
badd +0 app/assets/stylesheets/v5/diamond_partners.scss
argglobal
silent! argdel *
edit app/assets/stylesheets/v5/diamond_partners.scss
...
let s:l = 87 - ((47 * winheight(0) + 24) / 49)
