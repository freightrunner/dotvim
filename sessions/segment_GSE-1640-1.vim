...
set shortmess=aoO
badd +1 app/mailers/apostle_mailr/shipment_reminder.rb
badd +98 app/mailers/notifier.rb
badd +1 app/workers/reminder_notifications.rb
badd +896 app/models/analytics.rb
argglobal
silent! argdel *
...
let s:l = 1123 - ((32 * winheight(0) + 24) / 49)
