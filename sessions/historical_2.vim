...
set shortmess=aoO
badd +267 app/models/user.rb
badd +10 spec/services/generators/user_subscriptor_spec.rb
badd +5 spec/services/carts/generator_spec.rb
argglobal
silent! argdel *
$argadd app/models/user.rb
edit spec/services/carts/generator_spec.rb
