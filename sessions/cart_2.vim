...
badd +15 spec/controllers/api/v5/carts_controller_spec.rb
badd +89 spec/controllers/api/v5/cart_items_controller_spec.rb
badd +28 spec/controllers/api/v5/travelers_controller_spec.rb
badd +29 spec/services/travelers/create_spec.rb
badd +44 spec/controllers/api/v5/users_controller_spec.rb
badd +12 spec/models/cart_item_spec.rb
badd +15 spec/serializers/cart_serializer_spec.rb
argglobal
silent! argdel *
$argadd spec/models/cart_spec.rb
edit spec/controllers/api/v5/users_controller_spec.rb
...
let s:l = 85 - ((6 * winheight(0) + 24) / 49)
